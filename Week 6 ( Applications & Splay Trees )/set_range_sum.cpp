...
Vertex *left_desc(Vertex *n)
{
  ...
  else
  {
    ...
    return left_desc(n->left);
  }
}
Vertex *right_ances(Vertex *n)
{
  if (n->parent == NULL)
  {
    return n;
...
Vertex *next(Vertex *n)
{
  ...
  if (n->right != NULL)
  {
    return left_desc(n->right);
  }
  else
  {

    return right_ances(n);
  }
}
...
void erase(int x)
{
  ...
  if (ne == node)
  {
    // std::cout << "node itself deletion\n";
    if (node != root)
    {
      splay(root, node);
    }
    // std::cout << "splayed deletion\n";
  }
  else
  {
  ...
  Vertex *todel = root;
  // cout<<"to delete = "<<todel->key;
  //  std::cout << "Reached deletion\n";
...
long long sum(int from, int to)
{
  ...
  // std::cout << "\nThe elements in left are : ";
  // inorder(left);
  // std::cout << "\nThe elements in middle are : ";
  // inorder(middle);
  // std::cout << "\nThe elements in right are : ";
  // inorder(right);
